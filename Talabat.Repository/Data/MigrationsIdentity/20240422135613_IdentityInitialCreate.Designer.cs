...
namespace Talabat.Repository.Data.MigrationsIdentity
{
    ...
    [Migration("20240422135613_IdentityInitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabat.Core.Entities.Identity.OrderAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talabat.Core.Entities.Identity.OrderAddress", b =>
                {
                    b.HasOne("Talabat.Core.Entities.Identity.AppUser", "User")
                        ...
                        .HasForeignKey("Talabat.Core.Entities.Identity.OrderAddress", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
